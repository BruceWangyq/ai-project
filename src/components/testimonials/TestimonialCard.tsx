...
const TestimonialCard = ({ testimonial }: TestimonialCardProps) => {
  ...
  return (
    <div className="w-full">
      <div
        className="wow fadeInUp shadow-one rounded-2xl border-4 border-black bg-transparent p-8 dark:border-white lg:px-5 xl:px-8"
        data-wow-delay=".1s"
      >
        ...
        <div className="flex items-center">
          ...
          <div className="w-full">
            ...
            <p className="text-body-color text-dark text-sm dark:text-white">
              {designation}
            </p>
          </div>
        </div>
